...
import static frc.robot.Constants.DriveConstants.HEADING_MAX_ACCELERATION;
import static frc.robot.Constants.DriveConstants.HEADING_MAX_VELOCITY;
import static frc.robot.Constants.DriveConstants.HEADING_TOLERANCE;
import static frc.robot.Constants.DriveConstants.HEADING_kD;
import static frc.robot.Constants.DriveConstants.HEADING_kI;
import static frc.robot.Constants.DriveConstants.HEADING_kP;
import static frc.robot.Constants.DriveConstants.X_RATE_LIMIT;
import static frc.robot.Constants.DriveConstants.Y_RATE_LIMIT;
...
public class FieldHeadingDriveCommand extends Command {
  ...
  public void initialize() {
    ...
    var chassisSpeeds = drivetrainSubsystem.getTargetSpeeds(0, 0, 0, 0);
    var fieldSpeeds = 
